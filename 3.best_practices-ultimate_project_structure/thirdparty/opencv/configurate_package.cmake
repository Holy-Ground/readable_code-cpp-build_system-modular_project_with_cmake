...
set(${PROJECT_NAME}_INSTALL_PATH ${CMAKE_SOURCE_DIR}/thirdparty/install/${CMAKE_BUILD_TYPE}/${PROJECT_NAME} CACHE STRING "OPENCV install path")
set(${PROJECT_NAME}_CMAKE_PATH ${${PROJECT_NAME}_INSTALL_PATH}/lib/cmake/opencv4 CACHE STRING "OPENCV cmake path")
set(
...
set(${PROJECT_NAME}_LIBRARIES OpenCV CACHE STRING "GTEST library path")
